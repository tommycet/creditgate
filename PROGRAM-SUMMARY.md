...
## Current State (180 tests, 16 suites, 0 failures)
...
- **Newer features added beyond the M1 security sweep** (grew the suite 91 → 180 tests / 7 → 16 suites):
...
## Build Commands
- `forge test` — run all 180 tests across 16 suites
