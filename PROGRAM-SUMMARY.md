...
## Current State (171 tests, 15 suites, 0 failures)
...
- **Newer features added beyond the M1 security sweep** (grew the suite 91 → 171 tests / 7 → 15 suites):
...
## Build Commands
- `forge test` — run all 171 tests across 15 suites
